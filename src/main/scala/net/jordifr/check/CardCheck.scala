...
class CardCheck {
  ...
  val rules = List[Rule](
    ...
    new PrefixRangeRule(cardType = DiscoverCard, prefixInit = "622126", prefixEnd = "622925", minSize = 16, maxSize = 16),
    new PrefixRangeRule(cardType = DiscoverCard, prefixInit = "622126", prefixEnd = "622925", minSize = 19, maxSize = 19),
    ...
    new PrefixRule(cardType = DiscoverCard, prefix = "6011", minSize = 16, maxSize = 16),
    new PrefixRule(cardType = DiscoverCard, prefix = "6011", minSize = 19, maxSize = 19),
    new PrefixRangeRule(cardType = DiscoverCard, prefixInit = "644", prefixEnd = "649", minSize = 16, maxSize = 16),
    new PrefixRangeRule(cardType = DiscoverCard, prefixInit = "644", prefixEnd = "649", minSize = 19, maxSize = 19),
    new PrefixRule(cardType = DiscoverCard, prefix = "65", minSize = 16, maxSize = 16),
    new PrefixRule(cardType = DiscoverCard, prefix = "65", minSize = 19, maxSize = 19),
